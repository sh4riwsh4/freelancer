...
public class RHOKPSPublicSoap
{
    ...
    public RHOKPSPublicSoap(){}

    public RHOKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public RHOKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        RHOExtendedSoapSerializationEnvelope envelope= new RHOExtendedSoapSerializationEnvelope(RHOExtendedSoapSerializationEnvelope.VER11);
