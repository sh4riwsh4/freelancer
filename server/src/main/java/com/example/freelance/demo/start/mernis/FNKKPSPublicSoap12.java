...
public class FNKKPSPublicSoap12
{
    ...
    public FNKKPSPublicSoap12(){}

    public FNKKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public FNKKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        FNKExtendedSoapSerializationEnvelope envelope= new FNKExtendedSoapSerializationEnvelope(FNKExtendedSoapSerializationEnvelope.VER12);
